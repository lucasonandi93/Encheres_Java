...
public class AppliTestDAL {
	...
	public static void main(String[] args) {
		...
		User alexandra = new User("Masque_Panda", "Boulay", "Alexandra", "alex.boulay@orange.fr", "07-85-66-90-96", "rue de la foret", "53540", "LAUBRIERES", "quiqui35", 1000, false);
		...
		Article souris = new Article("Souris sans fil", "Une souris sans fil (Connection Bluetooth)", LocalDate.of(2023, 03, 10), LocalDate.of(2023, 03, 12), 2, 1, withdrawa5);
		...
		try {
			...
			alexandra = new User("BB_Panda", "Boulay", "Alexandra", "alex.boulay@orange.fr", "07-85-66-90-96", "rue de la foret", "53540", "LAUBRIERES", "quiqui35", 1000, false);
			userDAO.update(alexandra);
			//Test avec erreur
			
			//Test de la méthode update de articleDAO
			pcGamer = new Article("PC Gamer cassé", "Un super PC fixe avec de grosses performances", LocalDate.of(2023, 01, 20), LocalDate.of(2023, 02, 01), 1, 1, withdrawal);
