		...
		<form action="<%=request.getContextPath()%>/ServletNewArticle"
			...
			<div class="form-group">
				...
				<br> <br> <label for="endAuction">Fin de l'enchère
					:</label> <input type="date" name="articleEndDate"
				...
				<fieldset>
					...
					<br> <b> Code postal : </b><input type="text"
						name="withdrawalCp" value="${sessionScope.user.getCp() }"
						size="18" maxlength="15"> <br> <b> Ville : </b><input
						type="text" name="withdrawalCity"
