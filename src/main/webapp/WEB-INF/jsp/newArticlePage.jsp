...
<body>
	...
	<fieldset>
		<form action="<%=request.getContextPath()%>/ServletListOfAuctionsPage" method="post">
			...
			<div class="avatar">
				<input type="file" id="photoArticle" name="articlePhoto" accept="image/png, image/jpeg">
			</div>
			<br>
			<div class="form-group">
				...
				<fieldset>
					...
					Rue : <input type="text" name="withdrawalStreet" value="${sessionScope.user.getStreet() }" size="25" maxlength="30"> <br>
					Code postal : <input type="text" name="withdrawalCp" value="${sessionScope.user.getCp() }" size="18" maxlength="15"> <br>
